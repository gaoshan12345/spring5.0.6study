...
public class BeanDefinitionParserDelegate {
	...
	public BeanDefinition parseCustomElement(Element ele, @Nullable BeanDefinition containingBd) {
		logger.info("parseCustomElement nodeName = " + ele.getNodeName() + ",tagName = " + ele.getTagName());
		...
		logger.info("parseCustomElement namespaceUri = " + namespaceUri + ",handler = " + handler);
		/**
		 * 拿到的handler类似于ContextNamespaceHandler或AopNamespaceHandler，
		 * 他们都继承自抽象类NamespaceHandlerSupport，
		 * 所以最终调用的是调用抽象类NamespaceHandlerSupport的parse方法
		 *
