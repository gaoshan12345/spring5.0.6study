...
public abstract class FrameworkServlet extends HttpServletBean implements ApplicationContextAware {
	...
	protected WebApplicationContext initWebApplicationContext() {
		/**
		 * 获取父上下文，本质是从ServletContext的att中获取WebApplicationContext.class.getName() + ".ROOT"的值
		 * sc.getAttribute(attrName)
		 *
		 * 如果有父上下文，那么会将父上下文放入servletContext
		 * 参考ContextLoader类的initWebApplicationContext方法
	...
	protected WebApplicationContext createWebApplicationContext(@Nullable ApplicationContext parent) {
		//初始情况下，采用默认值，即XmlWebApplicationContext。public static final Class<?> DEFAULT_CONTEXT_CLASS = XmlWebApplicationContext.class;
		...
		//里面调用AbstractApplicationContext类的refresh方法
	...
	protected void configureAndRefreshWebApplicationContext(ConfigurableWebApplicationContext wac) {
		...
		/**
		 * 调用XmlWebApplicationContext类的refresh方法。
		 * XmlWebApplicationContext类继承自AbstractApplicationContext，所以最终调用的是AbstractApplicationContext类的refresh方法
		 */
		wac.refresh();
	}
