...
public abstract class AbstractMessageConverterMethodProcessor extends AbstractMessageConverterMethodArgumentResolver
	...
	protected <T> void writeWithMessageConverters(@Nullable T value, MethodParameter returnType,
		...
		logger.info("writeWithMessageConverters contentType = " + contentType);
		...
		if (selectedMediaType != null) {
			...
			logger.info("writeWithMessageConverters selectedMediaType = " + selectedMediaType.toString());
			for (HttpMessageConverter<?> converter : this.messageConverters) {
				GenericHttpMessageConverter genericConverter =
						(converter instanceof GenericHttpMessageConverter ? (GenericHttpMessageConverter<?>) converter : null);
				//添加注解开始
				logger.info("writeWithMessageConverters converter class = " + converter.getClass());
				logger.info("writeWithMessageConverters converter SupportedMediaTypes = " + converter.getSupportedMediaTypes().toString());
				if(genericConverter == null){
					logger.info("writeWithMessageConverters genericConverter is null");
				}else{
					logger.info("writeWithMessageConverters genericConverter class = " + genericConverter.getClass());
					logger.info("writeWithMessageConverters genericConverter SupportedMediaTypes = " + genericConverter.getSupportedMediaTypes().toString());
				}
				System.out.println();
				//添加注解结束
				if (genericConverter != null ?
